...
public class Map : MonoBehaviour {
    ...
    public static GameObject[,] createLandscape(int size_X, int size_Y, double chance_Forest=0.15, double chance_Mountain=0.05, double chance_Oasis=0.01,double chanceboost=0.2)
    {
        ...
        System.Random nRandDir = new System.Random();
        ...
        for (int y=0; y<size_Y; y++)
        {
            ...
            for(int x=0; x<size_X; x++)
            {
                ...
                int dir = nRandDir.Next(0, 5);
                discovered.transform.Rotate(new Vector3(0, 60 * dir, 0));
    ...
    public static void setActiveTile(HexaPos pos, HexaPos oldPos)
    {
        ...
        if (pos != oldPos)
        {
            ...
            int dir = randDir.Next(0, 5);
            restore.transform.Rotate(new Vector3(0, 60 * dir, 0));
            ...
            //restore.transform.localScale = new Vector3(100, 100, 100);
            Destroy(actmap);
        }
